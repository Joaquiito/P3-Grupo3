                ...
                switch (auxop) {
                    ...
                    case 1:
                        if (lso1.contador != 0) {
                            ...
                            for ( j = 0; j < lso1.contador; j++) {
                                muestraPantalla(lso1.list[j]);
                                getchar();
                            }
                        } else {
                    ...
                    case 2:
                        if (lsob1.contador != 0) {
                            for ( j = 0; j < lsob1.contador; j++) {
                                muestraPantalla(lsob1.list[j]);
                                getchar();
                            }
                        } else {
                            printf("La lista esta vacia.\n");
                    ...
                    case 4:
                        if (ReSe.contador != 0) {
                            for (j = 0; j< MLV; j++) {
                                printf("\n Lista %d\n", j + 1);
                                ReSe.cur = ReSe.arrlv[j].acc;
                                ReSe.aux = ReSe.arrlv[j].acc;
                                if (ReSe.cur == NULL) {
                                    printf("\n La lista esta vacia.\n");
                                } else {
                                    do {
                    ...
                    case 5:
                        if (ReAbLin.cant != 0) {
                            for (j = 0; j < MAX; j++) {
                                printf("Celda: %d\n", j);
                                if (ReAbLin.vendedores[j].documento == 0) {
                                    printf("\n\nCELDA VIRGEN. \n\n");
                                } else if (ReAbLin.vendedores[j].documento == 1) {
                                    printf("\n\nCELDA VACIA. \n\n");
                                } else {
                                    muestraPantalla(ReAbLin.vendedores[j]);
                                }
                                getchar();
                            }
                        } else {
